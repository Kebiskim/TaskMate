import { Carousel, Collapse, Layout, Typography } from "antd";
	...
	return (
		...
		>
			...
			>
				...
				>
					<Panel
						header="How TaskMate Can Help You"
						key="1"
						style={{ background: darkMode ? "#333" : "#fff" }}
					>
						<p style={{ color: darkMode ? "#ddd" : "#000" }}>
							TaskMate helps you organize your tasks with ease. It’s the perfect
							tool for managing your work and personal life.
						</p>
					</Panel>
					<Panel
						header="Pro Tips"
					...
					>
						<p style={{ color: darkMode ? "#ddd" : "#000" }}>
							Use the calendar view to get an overview of your tasks for the
							entire month.
						</p>
					</Panel>
				</Collapse>
